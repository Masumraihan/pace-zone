      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 grid-cols-1 gap-8 mt-6">
        <div className="lg:col-span-2 md:col-span-1 sm:col-span-1 col-span-1">
          ...
          <div className="lg:hidden md:hidden sm:flex flex flex-col">
            ...
            <div className="mt-3">
              {/*<Link href={"/physique-transformation-registration"} className='rounded-xl active:scale-95 shadow transition-transform px-4 py-2 text-center bg-[#330E83] w-full font-medium text-white'>Buy now</Link>*/}
              <Link
            ...
            {/*<Link href="#!" className='w-fit flex'>
              <span className='flex w-fit items-center gap-x-2 text-[#330E83] my-3 font-semibold'>View team pricing <Image src={ArrowLong} width={20} height={20} alt='arrow-long' /></span>
            </Link>
            <p className='text-gray-600'>*To see the monthly email send limit included with
              your specific plan, click Calculate my price. If your
              plan&apos;s contact or email send limit is exceeded, you
              will be charged for overages.</p>*/}
          </div>
        ...
        <div className="lg:flex md:flex sm:hidden hidden flex-col p-3">
          ...
          <div className="mt-3">
            {/*<Link href={"/physique-transformation-registration"} className='flex justify-center rounded-xl active:scale-95 shadow transition-transform px-4 py-2 text-center bg-[#330E83] w-full font-medium text-white'>Buy now</Link>*/}
            <Link
              href={`https://wa.me/7906089769/?text=`}
              target='_blank'
...
export default PhyTabsComponent