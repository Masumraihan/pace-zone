...
const TrustedByOrg = () => {
  ...
  return (
    <>
      <div className="2xl:container w-11/12 mx-auto border py-10">
        <div className="flex justify-center flex-col items-center">
          <h1 className='my-6 w-fit text-3xl text-center font-medium flex flex-col items-center gap-y-1'>Trusted by Organization of all sizes
          ...
          >
            {
              images.map((img, index) => {
                return (
                  <Slider.Slide key={index} className="h-36 flex justify-center items-center">
                    <Image src={img} alt="mentors-images" width={300} height={300} className='w-36 h-auto' />
                  </Slider.Slide>
                )
              })
            }
